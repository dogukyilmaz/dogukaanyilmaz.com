        ...
        <Box w={500}>
          ...
          <FormControl id="content" mt={4} isRequired>
            ...
            <Textarea
              ...
              onChange={handleChange}
            />
            <FormHelperText color="red.300">{errors.find((item: any) => item.key === 'content')?.content}</FormHelperText>
          </FormControl>
          <Box d="flex" justifyContent="flex-end">
            <Button w={200} isLoading={isSubmitted} colorScheme="teal" variant={isSubmitted ? 'solid' : 'outline'} onClick={handleSubmit}>
              {t('send')}
            </Button>
          </Box>
        </Box>
